...
class Dashboard extends Component {
  ...
  render() {
    return (
      <div className="page-wrapper dash">
                    ...
                    <table className="table table-hover table-center">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td className="text-center">
                            <span className="badge badge-pill bg-warning inv-badge">
                              Pending
                            </span>
                          </td>
                          <td className="text-right">
                        ...
                        <tr>
                          ...
                          <td className="text-center">1</td>
                          <td className="text-center">
                            <span className="badge badge-pill bg-danger inv-badge">
                              Cancel
                            </span>
                          </td>
                          <td className="text-right">
                  ...
                  <ul className="activity-feed">
                    <li className="feed-item">
                      ...
                      <span className="feed-text">
                        <a href="/react/template/app/profile">John Doe</a> added
                        new product{" "}
                        <a href="/react/template/app/ecommerce/product-details">
                          "Smart Watch"
                        </a>
                      </span>
                    </li>
                    <li className="feed-item">
                      ...
                      <span className="feed-text">
                        <a href="/react/template/app/profile">Justin Lee</a>{" "}
                        requested amount of{" "}
                        <a href="/react/template/app/ecommerce/invoice">
                          $5,781
                        </a>
                      </span>
                    </li>
                    <li className="feed-item">
                      ...
                      <span className="feed-text">
                        New user registered{" "}
                        <a href="/react/template/app/profile">"Mary Wiley"</a>
                      </span>
                    </li>
                    <li className="feed-item">
                      <div className="feed-date">Jan 27</div>
                      <span className="feed-text">
                        <a href="/react/template/app/profile">Robert Martin</a>{" "}
                        gave a review for{" "}
                        <a href="/react/template/app/ecommerce/product-details">
                          "Dell Laptop"
                        </a>
                    ...
                    <li className="feed-item">
                      ...
                      <span className="feed-text">
                        ...
                        <a href="/react/template/app/profile">"Tori Carter"</a>
                      </span>
                    </li>
                  </ul>
                </div>
