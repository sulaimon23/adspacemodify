...
export default function HeaderLinksTwo(props) {
        ...
        <ListItem className={classes.listItem}>
          <CustomDropdown
            ...
            dropdownList={[
              ...
              <Button onClick={props.logOutUser}className={classes.dropdownLink}  default block>
                Log out
              </Button>,
            ]}
          />
...
HeaderLinksTwo.defaultProps = {
  hoverColor: "primary",
};

HeaderLinksTwo.propTypes = {
